...
public class Modelovergrown_enderman<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "overgrown_enderman"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(35, 0)
						.addBox(-1.0F, 26.0F, 1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(56, 0)
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(56, 0).mirror()
						...
						.texOffs(35, 0).addBox(-1.0F, 26.0F, 1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, -13.0F, 0.0F));
