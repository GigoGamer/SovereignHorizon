...
public class SovereignHorizonModTabs {
	...
	public static final RegistryObject<CreativeModeTab> SOVEREIGN_HORIZON = REGISTRY.register("sovereign_horizon",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.sovereign_horizon.sovereign_horizon")).icon(() -> new ItemStack(SovereignHorizonModBlocks.SODALITE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(SovereignHorizonModBlocks.LARIMAR_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.LARIMAR_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.LARIMAR_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_LARIMAR.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_LARIMAR_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_LARIMAR_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_LARIMAR_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.LEPIDOLITE.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.LEPIDOLITE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.LEPIDOLITE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.LEPIDOLITE_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_LEPIDOLITE.get().asItem());
				...
				tabData.accept(SovereignHorizonModBlocks.THULITE_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_THULITE.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_THULITE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_THULITE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.POLISHED_THULITE_WALL.get().asItem());
				...
				tabData.accept(SovereignHorizonModBlocks.SODALITEAND_THULITE_TILES.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.SODALITEAND_THULITE_TILE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.SODALITEAND_THULITE_TILE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.SODALITEAND_THULITE_TILE_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_THULITE_TILES.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_THULITE_TILE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_THULITE_TILE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_THULITE_TILE_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_SODALITE_TILES.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_SODALITE_TILE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_SODALITE_TILE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_SODALITE_TILE_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.THULITEAND_LEPIDOLITE_TILES.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.THULITEAND_LEPIDOLITE_TILE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.THULITEAND_LEPIDOLITE_TILE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.THULITEAND_LEPIDOLITE_TILE_WALL.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_LEPIDOLITE_TILES.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_LEPIDOLITE_TILE_STAIRS.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_LEPIDOLITE_TILE_SLAB.get().asItem());
				tabData.accept(SovereignHorizonModBlocks.MARBLEAND_LEPIDOLITE_TILE_WALL.get().asItem());
