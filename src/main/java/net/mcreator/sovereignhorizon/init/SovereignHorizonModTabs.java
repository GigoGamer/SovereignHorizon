...
public class SovereignHorizonModTabs {
	...
	public static final RegistryObject<CreativeModeTab> SOVEREIGN_HORIZONS_TAB = REGISTRY.register("sovereign_horizons_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.sovereign_horizon.sovereign_horizons_tab")).icon(() -> new ItemStack(SovereignHorizonModBlocks.SODALITE.get())).displayItems((parameters, tabData) -> {
