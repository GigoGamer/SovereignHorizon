...
import net.mcreator.sovereignhorizon.block.SodaliteandLepidoliteTileSlabBlock;
...
import net.mcreator.sovereignhorizon.block.PolishedThuliteWallBlock;
import net.mcreator.sovereignhorizon.block.PolishedThuliteStairsBlock;
import net.mcreator.sovereignhorizon.block.PolishedThuliteSlabBlock;
import net.mcreator.sovereignhorizon.block.PolishedThuliteBlock;
...
import net.mcreator.sovereignhorizon.block.PolishedLepidoliteWallBlock;
import net.mcreator.sovereignhorizon.block.PolishedLepidoliteStairsBlock;
import net.mcreator.sovereignhorizon.block.PolishedLepidoliteSlabBlock;
import net.mcreator.sovereignhorizon.block.PolishedLepidoliteBlock;
import net.mcreator.sovereignhorizon.block.PolishedLarimarWallBlock;
...
import net.mcreator.sovereignhorizon.block.LepidoliteWallBlock;
import net.mcreator.sovereignhorizon.block.LepidoliteStairsBlock;
import net.mcreator.sovereignhorizon.block.LepidoliteSlabBlock;
import net.mcreator.sovereignhorizon.block.LepidoliteBlock;
import net.mcreator.sovereignhorizon.block.LarimarWallBlock;
import net.mcreator.sovereignhorizon.block.LarimarStairsBlock;
import net.mcreator.sovereignhorizon.block.LarimarSlabBlock;
...
public class SovereignHorizonModBlocks {
	...
	public static final RegistryObject<Block> LARIMAR_STAIRS = REGISTRY.register("larimar_stairs", () -> new LarimarStairsBlock());
	public static final RegistryObject<Block> LARIMAR_SLAB = REGISTRY.register("larimar_slab", () -> new LarimarSlabBlock());
	public static final RegistryObject<Block> LARIMAR_WALL = REGISTRY.register("larimar_wall", () -> new LarimarWallBlock());
	public static final RegistryObject<Block> POLISHED_LARIMAR = REGISTRY.register("polished_larimar", () -> new PolishedLarimarBlock());
	public static final RegistryObject<Block> POLISHED_LARIMAR_STAIRS = REGISTRY.register("polished_larimar_stairs", () -> new PolishedLarimarStairsBlock());
	public static final RegistryObject<Block> POLISHED_LARIMAR_SLAB = REGISTRY.register("polished_larimar_slab", () -> new PolishedLarimarSlabBlock());
	public static final RegistryObject<Block> POLISHED_LARIMAR_WALL = REGISTRY.register("polished_larimar_wall", () -> new PolishedLarimarWallBlock());
	public static final RegistryObject<Block> LEPIDOLITE_STAIRS = REGISTRY.register("lepidolite_stairs", () -> new LepidoliteStairsBlock());
	public static final RegistryObject<Block> LEPIDOLITE_SLAB = REGISTRY.register("lepidolite_slab", () -> new LepidoliteSlabBlock());
	public static final RegistryObject<Block> LEPIDOLITE_WALL = REGISTRY.register("lepidolite_wall", () -> new LepidoliteWallBlock());
	public static final RegistryObject<Block> POLISHED_LEPIDOLITE = REGISTRY.register("polished_lepidolite", () -> new PolishedLepidoliteBlock());
	public static final RegistryObject<Block> POLISHED_LEPIDOLITE_STAIRS = REGISTRY.register("polished_lepidolite_stairs", () -> new PolishedLepidoliteStairsBlock());
	public static final RegistryObject<Block> POLISHED_LEPIDOLITE_SLAB = REGISTRY.register("polished_lepidolite_slab", () -> new PolishedLepidoliteSlabBlock());
	public static final RegistryObject<Block> POLISHED_LEPIDOLITE_WALL = REGISTRY.register("polished_lepidolite_wall", () -> new PolishedLepidoliteWallBlock());
	public static final RegistryObject<Block> THULITE_STAIRS = REGISTRY.register("thulite_stairs", () -> new ThuliteStairsBlock());
	public static final RegistryObject<Block> THULITE_SLAB = REGISTRY.register("thulite_slab", () -> new ThuliteSlabBlock());
	public static final RegistryObject<Block> THULITE_WALL = REGISTRY.register("thulite_wall", () -> new ThuliteWallBlock());
	public static final RegistryObject<Block> POLISHED_THULITE = REGISTRY.register("polished_thulite", () -> new PolishedThuliteBlock());
