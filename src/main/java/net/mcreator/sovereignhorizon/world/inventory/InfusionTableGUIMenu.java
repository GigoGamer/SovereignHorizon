...
package net.mcreator.sovereignhorizon.world.inventory;
...
public class InfusionTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public InfusionTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SovereignHorizonModMenus.INFUSION_TABLE_GUI.get(), id);
